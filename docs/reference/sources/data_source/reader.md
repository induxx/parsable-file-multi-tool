...
```
Similarly, to read data from a parsable multiline JSON file, the type field in the reader sub-directive should be set to jsonl and the filename field should specify the name and location of the JSON file.
