...
class LegacyApiClientTest extends TestCase
{
    private $curlHandle;
    ...
    {
        $client = new LegacyApiClient('http://example.com');
        $ref = new \ReflectionProperty(LegacyApiClient::class, 'handle');
    ...
    private function getApiClientMock($withHandle = true)
    {
        ...
        return new LegacyApiClient('http://example.com');
    }
    ...
    public function testGetApiEndpointReturnsEndpoint()
    {
        ...
        $ref = new \ReflectionProperty(LegacyApiClient::class, 'endpoints');
        $ref->setAccessible(true);
    ...
    public function testRefreshTokenCallsRefresh()
    {
        ...
        $ref = new \ReflectionProperty(LegacyApiClient::class, 'authenticatedAccount');
        $ref->setAccessible(true);
    ...
    public function testSearchSetsCurlOptions()
    {
        ...
        $ref = new \ReflectionProperty(LegacyApiClient::class, 'urlGenerator');
        $ref->setAccessible(true);
    ...
    public function testSetHeadersMergesHeaders()
    {
        ...
        $ref = new \ReflectionProperty(LegacyApiClient::class, 'headers');
        $ref->setAccessible(true);
