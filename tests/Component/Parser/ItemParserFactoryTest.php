...
class ItemParserFactoryTest extends TestCase
{
    ...
    public function test_joining_unsorted_file(): void
    {
        $path = __DIR__ . '/../../examples/data_file_%s.csv';
        ...
        $manager->addFiles($filePaths);
        $manager->addFiles([sprintf($path, '5_sort')]);
